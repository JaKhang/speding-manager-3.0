...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/view/icon/forward.png"))); // NOI18N
        ...
        cmdMonth.setFont(new java.awt.Font("Oswald", 0, 14)); // NOI18N
        ...
        cmdYear.setFont(new java.awt.Font("Oswald", 0, 14)); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/application/view/icon/previous.png"))); // NOI18N
    ...
    public Date getDate() {
        return new GregorianCalendar(selectedDate.getYear(), selectedDate.getMonth() - 1, selectedDate.getDay()).getTime();
    }
    ...
    public void nextDate() {
        setSelectedDate(selectedDate.getNextDate());
    }

    public void previousDate() {
        setSelectedDate(selectedDate.getPreviousDate());
    }

    public void previousMonth() {
        setSelectedDate(selectedDate.getPreviousMonth());
    }

    public void nextMonth() {
        setSelectedDate(selectedDate.getNextMonth());
    }
